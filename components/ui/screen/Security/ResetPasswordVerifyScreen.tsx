...
export default function ResetPasswordVerifyScreen({ navigation }: { navigation: any }) {
        ...
        <ScrollView contentContainerStyle={{ flexGrow: 1 }} style={styles.container}>
            ...
            >
                ...
                <View style={styles.inputOuter}>
                    <Text style={styles.label}>Verify Email Here</Text>
                    <TextInput
                        value={otp}
                        onChangeText={setOtp}
                        style={styles.input}
               ...
               <TouchableOpacity
                                ...
                                >
                                    <Text style={styles.forgotText}>(30s)Resend Email</Text>
               </TouchableOpacity> 
                <TouchableOpacity
